...
# CONFIG & CONSTANTS
ARTIST = "Скрябін - Андрій Кузьменко"
GENRE = "Synth-pop"
SITE = "https://www.facebook.com/skryabinofficial"
URL_PREFIX = "https://firebasestorage.googleapis.com/v0/b/kuzma-skryabin.appspot.com/o/"
URL_SUFFIX = "?alt=media"
IMAGE_COVER = "Cover.jpg"
LOCAL_PATH = "/Users/olehka/Desktop/Media/Music/Скрябін/Альбоми та сінгли/"
ID_PREFIX = "kuzma-skryabin-id"
...
def replace_file(string):
    return string.replace(" ", "%20").replace("+", "%2B").replace("Й", "Й").replace("й", "й").replace("Ї", "Ї").replace("ї", "ї")
